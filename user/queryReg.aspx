<%@ Page Title="" Language="C#" MasterPageFile="~/user/usermaster.Master" AutoEventWireup="true" CodeBehind="queryReg.aspx.cs" Inherits="shopingsite.user.queryReg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3 align="center">Ask a question.</h3>
        ...
        <table>
                ...
                <tr>
                    <td>
                        <asp:Label ID="msg" runat="server" Text="Enter your querry" ></asp:Label>
                    </td>
                    <td>
        ...
        <br />
        <asp:Button runat="server" Text="Submit querry" OnClick="Unnamed1_Click"  />
        </center>
</asp:Content>
